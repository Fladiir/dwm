...
#define STATUSBAR "./dwmstatus"  /* FIXME */
...
static const char *roficmd[] = { "rofi", "-combi-modi", "window,drun,script,ssh", "-theme", "~/.config/rofi/launchers/type-1/style-5.rasi", "-font", "FreeSans 12", "-show", "combi", "-icon-theme", "Papirus", "-show-icons", NULL };
